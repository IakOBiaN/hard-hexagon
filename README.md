...
A schematic representation of the model is shown in the figure. Alternatively, the model can be formulated as a model of hard disks of size <img style="height:1em;" src="images/disk_formula.png" /> and on a triangular lattice, where <i>d</i> is hard disk diameter and <i>a</i> is lattice spacing.
